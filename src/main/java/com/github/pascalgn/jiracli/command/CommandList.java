...
final class CommandList {
    ...
    private static final List<Class<Command>> COMMANDS = (List) Arrays.asList(Base64.class, Browse.class, Filter.class,
            ...
            Issues.class, Echo.class, Sort.class, Join.class, Split.class, Labels.class, Edit.class, Rest.class,
            Update.class, Replace.class, Boards.class, Sprints.class, Head.class);
